...
export const removeTodoRequest = (_id: string) => action(TodoTypes.REMOVE_TODO_REQUEST, { _id })
export const removeTodoSuccess = (todos: TodoData[]) => action(TodoTypes.REMOVE_TODO_SUCCESS, { todos })
export const changeTodoRequest = (_id: string) => action(TodoTypes.CHANGE_TODO_REQUEST, { _id })
